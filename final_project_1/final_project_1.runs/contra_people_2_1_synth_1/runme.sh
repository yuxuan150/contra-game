...
HD_PWD='U:/Downloads/ece385/final_project_111/final_project_1/final_project_1.runs/contra_people_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contra_people_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contra_people_2_1.tcl
