...
HD_PWD='U:/Downloads/ece385/final_project_111/final_project_1/final_project_1.runs/player2_1_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player2_1_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source player2_1_rom.tcl
