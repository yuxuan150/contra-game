...
HD_PWD='U:/Downloads/ece385/final_project_111/final_project_1/final_project_1.runs/player1_2_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log player1_2_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source player1_2_rom.tcl
