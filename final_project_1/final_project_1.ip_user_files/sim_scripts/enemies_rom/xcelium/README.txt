...
#
# Generated by export_simulation on Tue Dec 03 15:28:38 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './enemies_rom.sh' script.

./enemies_rom.sh -reset_run
...
./enemies_rom.sh -noclean_files

For more information on the script, please type './enemies_rom.sh -help'.
