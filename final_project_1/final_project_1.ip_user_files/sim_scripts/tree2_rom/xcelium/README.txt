...
#
# Generated by export_simulation on Thu Dec 12 16:31:40 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './tree2_rom.sh' script.

./tree2_rom.sh -reset_run
...
./tree2_rom.sh -noclean_files

For more information on the script, please type './tree2_rom.sh -help'.
